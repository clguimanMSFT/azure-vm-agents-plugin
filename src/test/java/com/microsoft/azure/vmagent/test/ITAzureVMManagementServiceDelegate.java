    ...
    public void verifyVirtualNetworkTest() {
        try{
           ...
           Assert.assertEquals(Constants.OP_SUCCESS,
            ...
            Assert.assertEquals(Messages.Azure_GC_Template_VirtualNetwork_NotFound(wrongVnet, vnetResourceGroup),
                    AzureVMManagementServiceDelegate
                            .verifyVirtualNetwork(servicePrincipal, wrongVnet, vnetResourceGroup, wrongVnet, false, testEnv.azureResourceGroup));
