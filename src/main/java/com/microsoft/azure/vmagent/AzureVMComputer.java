...
public class AzureVMComputer extends AbstractCloudComputer<AzureVMAgent> {
    ...
    @Override
    public final HttpResponse doDoDelete() throws IOException {
        return doDoDelete(new ExecutionEngine());
    }

    protected final HttpResponse doDoDelete(final ExecutionEngine executionEngine) throws IOException {
            ...
            Callable<Void> task = new Callable<Void>() {
                ...
                public Void call() throws Exception {
                    ...
                    try {
                        ...
                        LOGGER.log(Level.INFO, "AzureVMComputer: doDoDelete: Exception occurred while deleting agent",
                                e);
                        throw new AzureCloudException("AzureVMComputer: doDoDelete: "
                                + "Exception occurred while deleting agent", e);
                    }
                    return null;
                }
            };
    ...
    public final boolean isSetOfflineByUser() {
        return setOfflineByUser;
    }

    public final void setSetOfflineByUser(final oolean setOfflineByUser) {
     ...
     */
    @Override
    public final void waitUntilOnline() throws InterruptedException {
     ...
     */
    @Override
    public final void setTemporarilyOffline(final boolean setOffline, final OfflineCause oc) {
     ...
     */
    @Override
    public final void setTemporarilyOffline(final boolean setOffline) {
        setSetOfflineByUser(setOffline);
